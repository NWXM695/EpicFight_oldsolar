package net.EpicFight_oldsolar.skill_oldsolar;
...
public class skill_oldsolar extends WeaponInnateSkill implements ChargeableSkill {
	...
	public skill_oldsolar(Builder<? extends Skill> builder) {
		super(builder);
	...
	public Skill asSkill() {
		return ChargeableSkill.super.asSkill();
	}
}